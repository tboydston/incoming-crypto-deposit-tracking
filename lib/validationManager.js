...
const validations = {
  commands: {
    ...
    validateAddresses: {
      ...
      help: "Regenerates address chain and compares addresses to platform addresses to insure that platform addresses have not been tampered with. Inconsistencies will be logged and sent to Telegram directly.",
    },
    validateDeposits: {
      ...
      help: "Compares wallet deposits with deposits on the platform. Inconsistencies will be logged and sent to Telegram directly.",
    },
    watchDeposits: {
      required: ["coin", "method"],
      default: { method: "notifyAll" },
      name: "Watch Deposits",
      example: "node cli.js coin=BTC method=notifyNone",
  ...
  types: {
    ...
    method: ["notifyAll", "blockNotify", "walletNotify", "notifyNone"],
  },
  description: {
