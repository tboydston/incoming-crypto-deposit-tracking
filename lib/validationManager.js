...
const validations = {
  ...
  types: {
    ...
    method: ["cli", "silent", "blockNotify", "walletNotify"],
  },
  ...
  description: {
    ...
    blockNotify: "Accessed via bitcoind through blockNotify. New deposit notifications will be sent according to config policy.",
    walletNotify: "Accessed via bitcoind through walletNotify. New deposit notifications will be sent according to config policy."
  },
};
